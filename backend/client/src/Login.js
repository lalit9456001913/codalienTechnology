...
class Login extends React.Component{
    ...
    submitForm=(e)=>{
        ...
        const requestOptions = {
            ...
            body: JSON.stringify({ userEmail: this.state.userEmail,phoneNumber: this.state.phoneNumber,role:this.state.path=='/adminLogin'?"admin":"normal" })
        };
    ...
    render(){
        ...
        if(this.state.redirectToOtpPage){
            if(this.state.path=='/adminLogin'){
                return <OtpPage role="admin" email={this.state.userEmail} phoneNumber={this.state.phoneNumber} />
            }
            else{
                return <OtpPage role="normal" email={this.state.userEmail} phoneNumber={this.state.phoneNumber} />
            }
        }
        return (
            <>
